...
public class EditorPanel {
	...
	public EditorPanel(Gui gui, NavigatorPanel navigator) {
		...
		this.editor.setCaretColor(Config.INSTANCE.getCurrentColors().caret.value());
		this.editor.setContentType("text/enigma-sources");
		this.editor.setBackground(Config.INSTANCE.getCurrentColors().editorBackground.value());
