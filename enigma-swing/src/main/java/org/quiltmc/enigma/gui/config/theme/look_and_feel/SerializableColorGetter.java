...
@FunctionalInterface
public interface SerializableColorGetter extends Function<ConfigurableLafThemeProperties.LookAndFeelColors, ThemeProperties.SerializableColor> {
	static SerializableColorGetter of(TrackedSerializableColorGetter getter) {
		return of(getter.andThen(TrackedValue::value));
	}

	static SerializableColorGetter of(Function<ConfigurableLafThemeProperties.LookAndFeelColors, ThemeProperties.SerializableColor> getter) {
		return getter::apply;
	}
}
