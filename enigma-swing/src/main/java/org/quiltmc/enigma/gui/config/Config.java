...
public final class Config extends ReflectiveConfig {
	...
	public final TrackedValue<ValueMap<String>> recentFiles = this.map("").build();
	...
	public Theme getCurrentTheme() {
		return switch (this.activeLookAndFeel) {
			case DEFAULT -> this.defaultTheme.value();
			case DARCULA -> this.darculaTheme.value();
			case METAL -> this.metalTheme.value();
			case SYSTEM -> this.systemTheme.value();
			case NONE -> this.noneTheme.value();
		};
	}
