...
public class ConfigureKeyBindsDialog extends JDialog {
    ...
    public ConfigureKeyBindsDialog(Frame owner) {
        ...
        List<KeyBind> keyBinds = KeyBinds.CONFIGURABLE_KEY_BINDS;
        for (KeyBind keyBind : keyBinds) {
            // TODO: Separate keybinds into categories
    ...
    private void save() {
        ...
        if (!modifiedPanels.isEmpty()) {
            for (KeyBindPanel panel : modifiedPanels) {
                KeyBindsConfig.setKeyBind(panel.getKeyBind());
            }
            KeyBindsConfig.save();
        }
        setVisible(false);
    ...
    private class KeyBindPanel extends JPanel {
        ...
        private void startEditing() {
            ...
            ConfigureKeyBindsDialog.this.stopEditing(this);
        }
