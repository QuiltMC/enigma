...
public class AboutDialog {
	public static void show(JFrame parent) {
		...
		pane.add(new JLabel(I18n.translateFormatted("menu.help.about.version.external", Decompiler.VINEFLOWER.name, Enigma.VINEFLOWER_VERSION)), cb.pos(0, 3).width(2).build());
