...
| `File`>`Crash History` menu                               | `"menu.file.crash_history.aliases"`                        |
...
| `View`>`Entry Markers` menu                               | `"menu.view.entry_markers.aliases"`                        |
| `View`>`Entry Markers`>`Marker tooltips`                  | `"menu.view.entry_markers.tooltip.aliases"`                |
| `View`>`Entry Markers`>`Max markers per line (N)` menu    | `"menu.view.entry_markers.max_markers_per_line.aliases"`   |
| `View`>`Entry Markers`>`Mark entries`                     | `"menu.view.entry_markers.mark.aliases"`                   |
| `View`>`Entry Markers`>`Mark entries`>`Only declarations` | `"menu.view.entry_markers.mark.only_declarations.aliases"` |
| `View`>`Entry Markers`>`Mark entries`>`Obfuscated`        | `"menu.view.entry_markers.mark.obfuscated.aliases"`        |
| `View`>`Entry Markers`>`Mark entries`>`Fallback`          | `"menu.view.entry_markers.mark.fallback.aliases"`          |
| `View`>`Entry Markers`>`Mark entries`>`Proposed`          | `"menu.view.entry_markers.mark.proposed.aliases"`          |
| `View`>`Entry Markers`>`Mark entries`>`Deobfuscated`      | `"menu.view.entry_markers.mark.deobfuscated.aliases"`      |
