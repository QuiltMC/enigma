...
public record ClassStatsResult(@Nullable ClassEntry obfEntry, Map<StatType, Integer> totalMappable, Map<StatType, Integer> totalUnmapped) implements StatsResult {
	@Override
