...
public class TestTranslator {
	...
	public static void beforeClass() throws Exception {
		...
		EntryTree<EntryMapping> mappings = MappingFormat.ENIGMA_FILE.read(
