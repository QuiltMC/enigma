...
class TestReadWriteCycle {
	...
	@Test
	void testEnigmaFile() throws IOException, MappingParseException {
		this.testReadWriteCycle(MappingFormat.ENIGMA_FILE, true, ".enigma");
	}

	@Test
	void testEnigmaDir() throws IOException, MappingParseException {
		this.testReadWriteCycle(MappingFormat.ENIGMA_DIRECTORY, true, ".tmp");
	}

	@Test
	void testEnigmaZip() throws IOException, MappingParseException {
		this.testReadWriteCycle(MappingFormat.ENIGMA_ZIP, true, ".zip");
	}

	@Test
	void testTinyFile() throws IOException, MappingParseException {
		this.testReadWriteCycle(MappingFormat.TINY_FILE, false, ".tiny");
	}

	@Test
	void testTinyV2() throws IOException, MappingParseException {
