...
public class CheckMappingsCommandTest {
	...
	public void testWrong() {
		Assertions.assertThrows(IllegalStateException.class, () -> new CheckMappingsCommand().run(new File(PACKAGE_ACCESS).getAbsolutePath(), new File("src/test/resources" + "/packageAccess/wrongMappings").getAbsolutePath()));
	}
