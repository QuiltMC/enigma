	...
	public static void main(String[] args) {
		...
		try {
			...
			if (!Files.exists(mappingsFile)) {
				mappings = EntryRemapper.mapped(project.getClassProvider(), project.getJarIndex(), project.getMappingsIndex(), project.getRemapper().getJarProposedMappings(), new HashEntryTree<>(), enigma.getNameProposalServices());
			} else {
				Logger.info("Reading mappings...");
				mappings = EntryRemapper.mapped(project.getClassProvider(), project.getJarIndex(), project.getMappingsIndex(), project.getRemapper().getJarProposedMappings(), readWriteService.get().read(mappingsFile), enigma.getNameProposalServices());
			}
